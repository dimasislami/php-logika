...
var AutoFill = function( oDT, oConfig )
{
	...
	this.s = {
		/**
		 * @namespace Cached information about the little dragging icons (the filler)
		 */
		"filler": {
			"height": 0,
			"width": 0
...
AutoFill.prototype = {
	...
	"_fnInit": function ( dt, config )
	{
		...
		/* Auto Fill click and drag icons */
		var filler = $('<div/>', {
	...
	/**
	 * Position the filler icons over a cell
	 *  @method  _fnFillerPosition
	 *  @param   {Node} nTd Cell to position filler icons over
	 *  @returns void
	 */
